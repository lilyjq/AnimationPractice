...
public class PathViewddd extends SurfaceView implements SurfaceHolder.Callback, Runnable {
    ...
    public PathViewddd(Context context) {
        this(context, null);
    }

    public PathViewddd(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PathViewddd(Context context, AttributeSet attrs, int defStyleAttr) {
